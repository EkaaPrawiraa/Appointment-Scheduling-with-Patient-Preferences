...
const TimeSlotManagement = ({ onClose, timeSlotsUpdate }) => {
    ...
    const handleSubmit = async () => {
        ...
        if (dialogType === 'add') {
            try {
                const response = await axios.post('https://myappfix-egg0egd2ehahdjaa.southeastasia-01.azurewebsites.net/api/timeslots/single', data);
            ...
            try {
                const response = await axios.put(`https://myappfix-egg0egd2ehahdjaa.southeastasia-01.azurewebsites.net/api/timeslots/${editingTimeSlot._id}`, data);
    ...
    const handleDeleteTimeSlot = async (id) => {
        try {
            await axios.delete(`https://myappfix-egg0egd2ehahdjaa.southeastasia-01.azurewebsites.net/api/timeslots/${id}`);
