...
const DoctorManagement = ({ onClose,doctorss }) => {
    ...
    const handleSubmit = async () => {
        if (dialogType === 'add') {
            try {
                const response = await axios.post('https://myappfix-egg0egd2ehahdjaa.southeastasia-01.azurewebsites.net/api/doctors/single', { id_doctor: idDoctor, doctor_name: doctorName });
            ...
            try {
                const response = await axios.put(`https://myappfix-egg0egd2ehahdjaa.southeastasia-01.azurewebsites.net/api/doctors/${editingDoctor._id}`, { id_doctor: idDoctor, doctor_name: doctorName });
    ...
    const handleDeleteDoctor = async (id) => {
        try {
            await axios.delete(`https://myappfix-egg0egd2ehahdjaa.southeastasia-01.azurewebsites.net/api/doctors/${id}`);
